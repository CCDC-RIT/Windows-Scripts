...
wget -o /dev/null "https://raw.githubusercontent.com/CCDC-RIT/Windows-Scripts/master/defender-exploit-guard-settings.xml" -O "def-eg-settings.xml"
# Firewall script
...
wget -o /dev/null "https://raw.githubusercontent.com/CCDC-RIT/Logging-Scripts/main/agent_windows.conf" -O "agent_windows.conf"
