# wildcard/hivestorm: disable all users that aren't on the supplied list

# rotate krbtgt passwd twice

# change password for all users
# change password for one user (specify name)

# "secure" all users (remove password never expires and other settings)
