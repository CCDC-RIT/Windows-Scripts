...
if ($disablePsExec -eq $true) {
    ...
    reg add "HKLM\System\FCurrentControlSet\Services\LanmanServer\Parameters" /v AutoShareWks /t REG_DWORD /d 0 /f | Out-Null
